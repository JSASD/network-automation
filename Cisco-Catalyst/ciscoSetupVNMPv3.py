...
b64_username = "YWRtaW4="
b64_password = "Mjk2MGxtaQ=="
b64_passwordsnmp = "U3AzY2lhbFVDaXNjbyo="
...
def copyConfigs(usernameDecode, passwordDecode, passwordsnmpDecode, __location__):
    ...
    for host in iplist:
        ...
        try:
            ...
            net_connect.send_command_timing("snmp-server group jsasd v3 auth access jsasd")
            print("> Setup SNMP server group")

            net_connect.send_command_timing("snmp-server user initial jsasd v3 auth md5 " + passwordsnmpDecode + "  priv des " + passwordsnmpDecode)
