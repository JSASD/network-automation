##################################################
# ----------- hpSwitchChangePassword ----------- #
#                                                #
# --- Changes manager password of HP ProCurve -- #
# ------------------ switches ------------------ #
#                                                #
...
def ChangePassword(givenUsername, givenPassword, givenNewPass, __location__):
    """
    Change manager password using given parameters
    ...
    for host in hpiplist:
        ...
        try:
            ...
            net_connect.send_command_timing("password manager plaintext " + givenNewPass)
